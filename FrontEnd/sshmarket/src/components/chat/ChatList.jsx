            ...
            <TradeListContainer>
                {trades &&
                    trades.map((trade) => (
                        <TradeListBox
                            key={trade.tradeId}
                            onClick={(() => handleTradeClick(trade.tradeId), setMember(trade.memberResponseDto))}
                        >
                            <ProfileImageWrapper src={trade.memberResponseDto.profile}></ProfileImageWrapper>
                            <ProfileWrapper>
                                <ProfileNameWrapper>{trade.memberResponseDto.nickname}</ProfileNameWrapper>
