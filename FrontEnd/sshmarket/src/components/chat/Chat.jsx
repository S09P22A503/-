...
import { getTradeMessage, getTradeDetail, setTradeSell, setTradeBuy, getTraderProfile } from '../../api/trade.js';
    ...
    return (
        <TradeContainer>
                ...
                {messages &&
                    messages.map((message) =>
                        message.memberId === memberId ? (
                            <RightMessageBox key={message.id}>{message.message}</RightMessageBox>
                        ) : (
                ...
                {newMessages &&
                    newMessages.map((newMessage, index) =>
                        newMessage.memberId === memberId ? (
                            <RightMessageBox key={index}>{newMessage.message}</RightMessageBox>
                        ) : (
            ...
            <TypingBox onSubmit={sendMessage}>
                <TypingMessageWrapper value={message} onChange={ChangeMessages} placeholder="메세지를 입력하세요" />
