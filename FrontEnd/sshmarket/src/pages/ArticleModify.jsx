...
export default function ArticleModify() {
  ...
  return (
    <Container>
      ...
      <DropdownContainer>
        ...
        >
          ...
          {categoryOptions.map((categoryOption) => (
            <option value={categoryOption.key}>
        ...
        >
          ...
          {productOptions.map((productOption) => (
            <option value={productOption.itemId}>
        ...
        >
          ...
          {transactionOptions.map((transactionOption) => (
            <option value={transactionOption.value}>
              {transactionOption.label}
            </option>
          ))}
        </Dropdown>
        ...
        >
          ...
          {regionOptions.map((regionOption) => (
            <option value={regionOption.locationId}>
              {regionOption.locationName}
            </option>
          ))}
        </Dropdown>
      </DropdownContainer>
      ...
      <PriceChart itemId={selectedProductOption}></PriceChart>
